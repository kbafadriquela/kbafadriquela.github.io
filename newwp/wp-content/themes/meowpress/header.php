    ...
    <header class="container mx-auto py-6">
        <div class="md:flex md:justify-between md:items-center">
            <div class="flex justify-between items-center">
                <div class="w-[70px]">
                    <?php
                        $custom_logo_header = get_theme_mod('custom_logo');
                        $logo = wp_get_attachment_image_src( $custom_logo_header , 'full'); ?>
                    <?php if (has_custom_logo()): 
                        echo '<img class="custom-logo w-[7px]" src="' . esc_url( $logo[0] ) .'" alt="'. get_bloginfo('name') . '">';
                    ?>
                    <?php else: ?>
